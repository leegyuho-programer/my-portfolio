          ...
          process: [
            {
              ...
              content: [
                {
                  description:
                    'IntersectionObserver를 활용하여 **카드가 뷰포트 100px 이내에 들어오면 해당 프로젝트 상세 경로를 router.prefetch로 사전 로드**하도록 구현',
                },
                {
                  description:
                    '추가적으로 사용자가 프로젝트 카드에 마우스 오버(`onMouseEnter`)하거나 포커스(`onFocus`)할 때도 router.prefetch를 호출해 **인터랙션 기반의 사전 로딩**을 보완',
                },
              ],
            },
          ],
